---
description: >-
  The PantosToken ABI is a JSON representation of the PantosToken smart
  contract's interface, containing the functions and events necessary for
  interacting with cross-chain tokens
---
